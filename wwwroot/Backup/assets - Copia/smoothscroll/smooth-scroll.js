...
// Other Variables
    ...
    function init() {
         ...
         */
            ...
            fullPageElem.style.cssText = 'position:absolute;
 z-index:-10000;
 ' +
                'top:0;
 left:0;
 ...
 // could also be: clearTimeout(pendingRefresh);

                pendingRefresh = setTimeout(function () {
                    if (isExcluded) return;
 // could be running after cleanup
 ...
 // redefine event because already dispatched
 ...
 // a key we don't care about
    ...
    var cacheX = {};
 // cleared out after a scrolling session
    var cacheY = {};
 // cleared out after a scrolling session
    var clearCacheTimer;
    ...
    var getScrollRoot = (function() {
        ...
        return function() {
            if (!SCROLL_ROOT) {
                ...
                dummy.style.cssText = 'height:10000px;
width:1px;
';
