...
namespace RIAT.UI.Web.Controllers
{
    public class SintomasController : Controller
    {
        ...
        public SintomasController(RIATContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,SintNomeSintoma,SintCodSintoma,DoenIdDoenca")] Sintoma sintoma)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize(Roles = "Administradores, Profissionais")]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SintNomeSintoma,SintCodSintoma,DoenIdDoenca")] Sintoma sintoma)
        {
            if (id != sintoma.Id)
            {
                return NotFound();
