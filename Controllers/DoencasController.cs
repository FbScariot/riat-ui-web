...
namespace RIAT.UI.Web.Controllers
{
    ...
    public class DoencasController : Controller
    {
        ...
        public DoencasController(RIATContext context)
        {
            _context = context;
        }
        ...
        [Authorize(Roles = "Administradores, Profissionais")]
        public async Task<IActionResult> Create([Bind("Id,DoenCodDoenca,DoenNmHipotese")] Doenca doenca)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize(Roles = "Administradores, Profissionais")]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DoenCodDoenca,DoenNmHipotese")] Doenca doenca)
        {
            if (id != doenca.Id)
            {
                return NotFound();
